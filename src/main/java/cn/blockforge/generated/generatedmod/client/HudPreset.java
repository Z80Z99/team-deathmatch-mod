...
public enum HudPreset {
    ...
    public void apply(ClientHudLayout.Draft draft, HudContext context) {
        ...
        int white = 0xFFF0F2F3, accent = this == COUNTER_STRIKE ? 0xFFF0CE74
        ...
        if (this == CALL_OF_DUTY) {
            ...
            boolean cs = this == COUNTER_STRIKE;
            int wing = cs ? 65 : 104;
        ...
        status.progress("生命条", "health_percent", 100, -71, 172, accent);
        var personal = new HudAssemblies.Builder(draft, context, label, 100, 100);
        personal.line("个人统计", "击杀 {my_kills}  阵亡 {my_deaths}", -110, -85, 190, white);
        personal.text("队伍", "{team}", -110, -69, 190, accent, 90);
